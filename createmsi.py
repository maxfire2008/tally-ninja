...
class PackageGenerator:
    def __init__(self, jsondata):
        ...
        if self.need_msvcrt:
            if len(trials) > 1:
                sys.exit("There are more than one redist dirs: " + ", ".join(trials))
            if len(trials) == 0:
                sys.exit(
    ...
    def generate_files(self):
        ...
        if self.startmenu_shortcut is not None:
            ap = ET.SubElement(
                package, "StandardDirectory", {"Id": "ProgramMenuFolder"}
            )
            comp = ET.SubElement(
                ap,
                "Component",
        ...
        if self.registry_entries is not None:
            registry_entries_directory = targetdir = ET.SubElement(
                package,
                "StandardDirectory",
                {
                    "Id": "ProgramFiles64Folder",
    ...
    def create_licenseless_dialog_entries(self, product_element):
        ui = ET.SubElement(product_element, "UI", {"Id": "WixUI_FeatureTree"})

        ET.SubElement(
            ui,
            "TextStyle",
            {"Id": "WixUI_Font_Normal", "FaceName": "Tahoma", "Size": "8"},
        )

        ET.SubElement(
            ui,
            "TextStyle",
            {"Id": "WixUI_Font_Bigger", "FaceName": "Tahoma", "Size": "12"},
        )
        ...
        ET.SubElement(
            ui, "Property", {"Id": "DefaultUIFont", "Value": "WixUI_Font_Normal"}
        )

        ET.SubElement(ui, "Property", {"Id": "WixUI_Mode", "Value": "FeatureTree"})

        ET.SubElement(ui, "DialogRef", {"Id": "ErrorDlg"})

        ET.SubElement(ui, "DialogRef", {"Id": "FatalError"})

        ET.SubElement(ui, "DialogRef", {"Id": "FilesInUse"})

        ET.SubElement(ui, "DialogRef", {"Id": "MsiRMFilesInUse"})

        ET.SubElement(ui, "DialogRef", {"Id": "PrepareDlg"})

        ET.SubElement(ui, "DialogRef", {"Id": "ProgressDlg"})

        ET.SubElement(ui, "DialogRef", {"Id": "ResumeDlg"})

        ET.SubElement(ui, "DialogRef", {"Id": "UserExit"})

        pub_exit = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "ExitDialog",
        ...
        pub_welcome_next = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "WelcomeDlg",
        ...
        pub_welcome_maint_next = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "WelcomeDlg",
        ...
        pub_customize_back_maint = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "CustomizeDlg",
        ...
        pub_customize_back_welcome = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "CustomizeDlg",
        ...
        pub_customize_next = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "CustomizeDlg",
        ...
        pub_verify_customize_back = ET.SubElement(
            ui,
            "Publish",
            {
        ...
        pub_verify_maint_back = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "VerifyReadyDlg",
        ...
        pub_verify_welcome_back = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "VerifyReadyDlg",
        ...
        pub_maint_welcome_next = ET.SubElement(
            ui,
            "Publish",
            {
        ...
        pub_maint_type_change = ET.SubElement(
            ui,
            "Publish",
            {
        ...
        pub_maint_type_repair = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "MaintenanceTypeDlg",
        ...
        pub_maint_type_remove = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "MaintenanceTypeDlg",
        ...
        pub_maint_type_back = ET.SubElement(
            ui,
            "Publish",
            {
                "Dialog": "MaintenanceTypeDlg",
